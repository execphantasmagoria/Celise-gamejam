...
Celise: raylib
ifneq (,$(Celise_config))
	@echo "==== Building Celise ($(Celise_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f Celise.make config=$(Celise_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f Celise.make clean
